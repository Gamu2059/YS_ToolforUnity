...
namespace YS_Tool.Prefab {
    /// <summary>
    /// プレハブの管理を一元管理します。
    /// 継承して、プレハブを管轄的に管理することも可能です。
    /// </summary>
    public class PrefabManager<T> : LocalSingletonMonoBehavior<T> where T : MonoBehaviour {
        ...
        public GameObject GetOriginObject(string prefabName) {
            ...
            for (int i = 0; i < m_PrefabInfos.Count; i++) {
                ...
                if (prefabName == info.Name) return info.Prefab;
            }
        ...
        public class PrefabManagerEditor : Editor {
            ...
            public override void OnInspectorGUI() {
                ...
                if (GUILayout.Button("Generate Prefab Keyword")) {
                    ...
                    var editor = target as PrefabManager<T>;
