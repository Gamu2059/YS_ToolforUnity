...
namespace YS_Tool.IO {
    public class SaveDataSerializer : BaseDataSerializer {
        ...
        private class Serialization<T> {
            ...
            public Serialization(List<T> target) { m_Target = target; }

            public List<T> ToList() { return m_Target; }
        }
        ...
        private class Serialization<K, V> {
            ...
            public Serialization(Dictionary<K, V> target) { m_Target = target; }
            ...
            public Dictionary<K, V> ToDictionary() { return m_Target; }
        }
        ...
        public List<T> GetList<T>(string key, List<T> _default) {
            KeyCheck(key);
            if (!m_SaveDictionary.ContainsKey(key)) return _default;
        ...
        public int GetInt(string key, int _default) {
            ...
            int ret;
            if (!int.TryParse(m_SaveDictionary[key], out ret)) ret = _default;
            return ret;
        }
        ...
        public float GetFloat(string key, float _default) {
            ...
            float ret;
            if (!float.TryParse(m_SaveDictionary[key], out ret)) ret = _default;
            return ret;
        }
        ...
        public bool GetBool(string key, bool _default) {
            ...
            bool ret;
            if (!bool.TryParse(m_SaveDictionary[key], out ret)) ret = _default;
            return ret;
        }
