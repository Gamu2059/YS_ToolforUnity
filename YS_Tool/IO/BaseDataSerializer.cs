...
namespace YS_Tool.IO {
    ...
    public abstract class BaseDataSerializer {
        ...
        public void Save(Action onSuccess = null, Action onFailure = null) {
            FileIOManager.GetInstance().Save(GetFileFullPath(), this, onSuccess, onFailure);
        }
        ...
        public void Load(Action onSuccess = null, Action onFailure = null) {
            FileIOManager.GetInstance().Load(GetFileFullPath(), this, onSuccess, onFailure);
        }
        ...
        public void EncryptSave(Action onSuccess = null, Action onFailure = null) {
            FileIOManager.GetInstance().EncryptSave(GetFileFullPath(), this, onSuccess, onFailure);
        }
        ...
        public void EncryptLoad(Action onSuccess = null, Action onFailure = null) {
            FileIOManager.GetInstance().EncryptLoad(GetFileFullPath(), this, onSuccess, onFailure);
        }
